...
public class BadaudVieux extends PacificEnemy {

    public BadaudVieux(float startX, float startY, float range, GameStage gameStage) {
        super("badaud-vieux", startX, startY, range, gameStage);
