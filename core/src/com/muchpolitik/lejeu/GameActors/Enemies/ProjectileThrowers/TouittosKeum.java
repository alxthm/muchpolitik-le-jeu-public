...
public class TouittosKeum extends ProjectileThrower {

    public TouittosKeum(float startX, float startY, float range, GameStage gameStage) {
        super("touittos-keum", startX, startY, range, gameStage);
